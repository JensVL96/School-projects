...
class SudokuGUI(tk.Tk):
    def __init__(self, board):
        ...
        self.board.set_GUI(self)
        self.temp_board = SudokuBoard(board)
    ...
    def create_widgets(self):
        ...
        # for i in range(9):
            ...
            #     entry = tk.Entry(entry_frame, width=2)
            ...
            #     entry_frame.grid(row=i, column=j, padx=1, pady=1)
            ...
            #         separator_frame.grid(row=i + 1, column=j, sticky='ews')
        ...
        # clear_button = tk.Button(button_frame, text="Hint", command=self.hint)
        ...
        # reset_button = tk.Button(outer_frame, text="Reset", command=self.reset)
        # reset_button.grid(row=0, column=1, padx=50, sticky='we')
                    
        # exit_button = tk.Button(outer_frame, text="Solve", command=self.solve)
        # exit_button.grid(row=0, column=2, padx=50, pady=50, sticky='we')
    ...
    def solve(self):
        ...
        if self.board.recursive_solve():
            self.board.recursive_solve()
    ...
    def reset(self):
        print("reset def")
        self.update_gui(self.temp_board.nums)
