...
EL_SIZE = float(SCREEN_HEIGHT / 900)
BOX_SIZE = float(SCREEN_HEIGHT / 1800)
...
#   List of controls
CONTROL_PAD_1 = [pg.K_w, pg.K_a, pg.K_d, pg.K_LCTRL]
CONTROL_PAD_2 = [pg.K_UP, pg.K_LEFT, pg.K_RIGHT, pg.K_RCTRL]
