...
int main(int argc, char* argv[]) {
  ...
  */
  ...
  // open_db();
  // create_test_schema("test_join_A", 2, columns, attr_types);
  // fill_table("test_join_A", record_num);

  // create_test_schema("test_join_B", 2, columns, attr_types);
  // fill_table("test_join_B", record_num);
  ...
  test_tbl_natural_join(my_tbl, "You", 0); // nested-loop join
  test_tbl_natural_join(my_tbl, "You", 1); // block nested-loop join
