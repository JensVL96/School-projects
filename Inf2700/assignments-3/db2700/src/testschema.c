...
void test_tbl_natural_join(char const* my_tbl, char const* yr_tbl, int join_type) {
  ...
  table_natural_join(tbl_m, tbl_y, join_type);

  // if (join_result == NULL) {
  //     printf("Natural join failed. No common field found.\n");
  // } else {
  //     put_schema_info(INFO, join_result);
  // }
