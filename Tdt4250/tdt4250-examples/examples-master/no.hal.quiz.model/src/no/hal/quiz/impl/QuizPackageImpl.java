...
public class QuizPackageImpl extends EPackageImpl implements QuizPackage {
	...
	public static QuizPackage init() {
		...
		Object registeredQuizPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		QuizPackageImpl theQuizPackage = registeredQuizPackage instanceof QuizPackageImpl ? (QuizPackageImpl)registeredQuizPackage : new QuizPackageImpl();
