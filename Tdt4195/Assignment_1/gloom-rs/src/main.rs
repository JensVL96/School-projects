...
fn main() {
    ...
    let render_thread = thread::spawn(move || {
        ...
        // Clipped example from the assignment text
        // let vertices: Vec<f32> = vec![0.0, 0.4, 0.0, -0.8, -0.2, 1.2, 0.6, -0.8, -1.2]; 
       ...
       unsafe {simple_shader.activate()}
        ...
        loop {
            ...
            unsafe {
                ...
                // Random RNG values between 0 and 1
                ...
                if elapsed%1.0<0.1{
                    // Random RNG values sent to the shader vertices.
                    gl::Uniform1f(0, red);
